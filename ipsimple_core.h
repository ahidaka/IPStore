...
/* Modes used in the ipsm_chk() routine. */
...
extern struct ip_fw *ipsm_in_chain;
extern struct ip_fw *ipsm_out_chain;
extern struct ip_fw *ipsm_fwd_chain;
extern int ipsm_in_policy;
extern int ipsm_out_policy;
extern int ipsm_fwd_policy;
static int ipsm_ctl(int, void *, int);
#endif
#ifdef CONFIG_IP_ACCT
extern struct ip_fw *ipsm_acct_chain;
static int ipsm_acct_ctl(int, void *, int);
#endif
#ifdef CONFIG_IP_MASQUERADE
static int ipsm_masq_ctl(int, void *, int);
#endif
#ifdef CONFIG_IP_MASQUERADE
static int ipsm_masq_ctl(int, void *, int);
#endif

/* static int ipsm_masq_timeouts(void *user, int len); */

static int ipsm_chk(struct iphdr *, struct net_device *, __u16 *,
		     struct ip_fw *, int, int);

extern int ipsm_register_firewall(int pf, struct firewall_ops *fw);

extern int ipsm_unregister_firewall(int pf, struct firewall_ops *fw);
